...
` : `[${source[i]}\r
  ...
  class GoogleMcpServer {
    constructor() {
      ...
      this.server = new McpServer(
        { name: "Google MCP Server", version: "1.0.0" },
        {
          ...
          instructions: "Google.com tools: read page title, extract search query, read search results, and navigate paginated results."
        }
      );
    ...
    getSearchQuery() {
      ...
      const fromInput = (_a = input == null ? void 0 : input.value) == null ? void 0 : _a.trim();
    ...
    parseSearchResults(maxResults = 10) {
      ...
      for (const h3 of h3Nodes) {
        ...
        const container = anchor.closest("div.g, div.MjjYud, div");
        const title2 = ((_a = h3.textContent) == null ? void 0 : _a.trim()) || anchor.title || anchor.href;
        const snippetEl = (container == null ? void 0 : container.querySelector(
          'div[data-sncf], div[data-snf], div.VwiC3b, div.ylHkof, div.BNeawe, div[data-content-feature="1"]'
        )) || (container == null ? void 0 : container.querySelector("span.aCOpRe"));
        const snippet = ((_b = snippetEl == null ? void 0 : snippetEl.textContent) == null ? void 0 : _b.trim()) || null;
      ...
      try {
        ...
        this.server.registerTool(
          "run_search",
          {
            ...
            inputSchema: { query: stringType().min(1).describe("Search terms") },
        ...
        this.server.registerTool(
          "get_search_results",
          {
            ...
            inputSchema: {
              maxResults: numberType().int().min(1).max(50).optional().describe("Maximum number of results to return (default 10)")
            },
            annotations: { readOnlyHint: true, idempotentHint: true }
          },
          async ({ maxResults }) => {
        ...
        this.server.registerTool(
          ...
          async () => {
            ...
            try {
              ...
              const hasNext = Boolean(document.querySelector("#pnnext")) || true;
              const hasPrev = Boolean(document.querySelector("#pnprev")) || start > 0;
              const statsText = ((_b = (_a = document.querySelector("#result-stats")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim()) || null;
  ...
  let googleServer = null;
  async function ensureServer() {
    if (!googleServer) {
      googleServer = new GoogleMcpServer();
      window.googleMcpServer = googleServer;
    }
  }
