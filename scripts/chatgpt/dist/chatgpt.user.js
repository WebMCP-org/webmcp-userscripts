...
` : `[${source[i]}\r
  ...
  async function waitForSelector(selector, timeout = 5e3) {
  ...
  server.registerTool(
    "chatgpt_type_message",
    {
      ...
      inputSchema: {
        message: stringType().describe("The message to type in the input field")
      }
    },
    async ({ message }) => {
  ...
  server.registerTool(
    ...
    async () => {
      ...
      if (textarea instanceof HTMLTextAreaElement) {
        const sendButton = document.querySelector('button[aria-label*="Send"]') || document.querySelector('button[data-testid*="send"]') || ((_a = document.querySelector('button svg path[d*="M4.175 10.825"]')) == null ? void 0 : _a.closest("button"));
  ...
  server.registerTool(
    "chatgpt_get_messages",
    {
      ...
      inputSchema: {
        role: enumType(["all", "user", "assistant"]).optional().default("all").describe("Filter messages by role")
      }
    },
    async ({ role }) => {
      ...
      const messageTexts = Array.from(messages).map((msg, index) => {
        var _a;
        const content = ((_a = msg.querySelector(".prose")) == null ? void 0 : _a.textContent) || msg.textContent || "";
  ...
  server.registerTool(
    ...
    async () => {
      ...
      if (lastMessage) {
        const content = ((_a = lastMessage.querySelector(".prose")) == null ? void 0 : _a.textContent) || lastMessage.textContent || "";
        return {
          content: [{
            type: "text",
            text: content.trim()
  ...
  server.registerTool(
    ...
    async () => {
      ...
      const state = {
        ...
        currentModel: ((_a = document.querySelector(ChatGPTSelectors.chat.modelSwitcher)) == null ? void 0 : _a.textContent) || "Unknown",
  ...
  server.registerTool(
    ...
    async () => {
      ...
      const codes = Array.from(codeBlocks).map((block, index) => {
        var _a;
        const language = ((_a = block.className.match(/language-(\w+)/)) == null ? void 0 : _a[1]) || "unknown";
  ...
  server.registerTool(
    ...
    async () => {
      ...
      const sendButtons = allButtons.filter((btn) => {
        ...
        return ariaLabel.toLowerCase().includes("send") || hasPath || nearTextarea && !btn.disabled && btn.offsetWidth > 0;
      });
      const debugInfo = {
        textarea: {
          found: !!textarea,
          value: (textarea == null ? void 0 : textarea.value) || "",
          valueLength: ((_a = textarea == null ? void 0 : textarea.value) == null ? void 0 : _a.length) || 0,
          placeholder: (textarea == null ? void 0 : textarea.placeholder) || "",
          disabled: (textarea == null ? void 0 : textarea.disabled) || false,
          readOnly: (textarea == null ? void 0 : textarea.readOnly) || false,
          parentClasses: ((_b = textarea == null ? void 0 : textarea.parentElement) == null ? void 0 : _b.className) || ""
        },
        sendButtons: sendButtons.map((btn, i) => {
          ...
          return {
            index: i,
            found: !!btn,
            disabled: (btn == null ? void 0 : btn.disabled) || false,
            ariaLabel: (btn == null ? void 0 : btn.getAttribute("aria-label")) || "",
            className: (btn == null ? void 0 : btn.className) || "",
            hasClickHandler: !!(btn == null ? void 0 : btn.onclick),
            innerHTML: ((_a2 = btn == null ? void 0 : btn.innerHTML) == null ? void 0 : _a2.substring(0, 100)) || ""
          };
        }),
        reactFiber: {
          textareaHasReactFiber: !!(textarea == null ? void 0 : textarea._reactInternalFiber) || !!(textarea == null ? void 0 : textarea._reactInternalInstance),
          textareaReactProps: !!(textarea == null ? void 0 : textarea.__reactProps)
        }
      };
      return {
        content: [{
