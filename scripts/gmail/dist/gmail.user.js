...
System.register("./__entry.js", ['./gmail-DvJplqtb-C6DPSp5R.js'], (function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: (async function () {
      ...
      function compile$1(schema, root, localRefs, baseId) {
        ...
        function localCompile(_schema, _root, localRefs2, baseId2) {
          ...
          if (_root.schema != root.schema)
            return compile$1.call(self, _schema, _root, localRefs2, baseId2);
        ...
        function resolveRef(baseId2, ref2, isRoot) {
          ...
          var v2 = resolve$1.call(self, localCompile, root, ref2);
          if (v2 === void 0) {
            var localSchema = localRefs && localRefs[ref2];
            if (localSchema) {
              v2 = resolve$1.inlineRef(localSchema, opts.inlineRefs) ? localSchema : compile$1.call(self, localSchema, root, localRefs, baseId2);
            }
          }
          if (v2 === void 0) {
            removeLocalRef(ref2);
      ...
      function addDefaultMetaSchema(self) {
        ...
        if (self._opts.$data) metaSchema2 = $dataMetaSchema(metaSchema2, META_SUPPORT_DATA);
        self.addMetaSchema(metaSchema2, META_SCHEMA_ID, true);
...
${JSON.stringify(data2, null, 2)}` : message
      ...
      const GmailFactory = await __vitePreload(() => module.import('./gmail-DvJplqtb-C6DPSp5R.js').then((n) => n.g), void 0 );
...
System.register("./gmail-DvJplqtb-C6DPSp5R.js", [], (function (exports, module) {
  'use strict';
  return {
    execute: (function () {

      exports("a", getDefaultExportFromCjs);
      ...
      const gmail$1 = exports("g", /* @__PURE__ */ _mergeNamespaces({
        __proto__: null,
        default: gmail
      }, [gmail$2]));
